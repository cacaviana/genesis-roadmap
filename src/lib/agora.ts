...
// + publish em genesis-campanhas`,
  ...
  },
  {
    ...
    tag: '🆕 Sandbox paralelo',
    resumo: 'Cópia funcional pra testes. NÃO toca o messaging-service da Polly.',
    variante: 'purple',
    ondeMora: 'Azure App Service · `messaging-service-sandbox`',
    oQueFaz: 'Fork cacaviana/messaging-service rodando: send_worker consome messaging.send, publica em messaging.status, webhook receiver em /webhooks/meta/whatsapp.',
    recebeDe: ['Smoke test publicou msg em messaging.send (validado E2E)'],
    entrega: ['Twilio/Meta/ACS (live mode, mas só sandbox usa por enquanto)'],
    payloadEntrada: {
